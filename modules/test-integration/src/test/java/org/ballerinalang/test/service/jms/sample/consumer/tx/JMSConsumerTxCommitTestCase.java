 ...
 */
public class JMSConsumerTxCommitTestCase extends IntegrationTestCase {
    private static final Logger log = LoggerFactory.getLogger(JMSConsumerTxCommitTestCase.class);
    ...
    @Test(description = "Test JMS receiver local tx commit operation")
    public void testJMSSendReceive() throws Exception {
        ...
        String relativePath = new File(
                "src" + File.separator + "test" + File.separator + "resources" + File.separator + "jms" + File.separator
                        + "tx" + File.separator + "jmsReceiverTxCommit.bal").getAbsolutePath();
